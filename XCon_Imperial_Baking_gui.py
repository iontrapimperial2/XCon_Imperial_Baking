...
class Ui_XCon_Imperial_Baking(object):
    def setupUi(self, XCon_Imperial_Baking):
        ...
        self.pushButton_save_ch_input = QtWidgets.QPushButton(self.centralWidget)
        self.pushButton_save_ch_input.setObjectName("pushButton_save_ch_input")
        self.gridLayout.addWidget(self.pushButton_save_ch_input, 4, 4, 1, 1)
    ...
    def retranslateUi(self, XCon_Imperial_Baking):
        ...
        self.pushButton_save_ch_input.setText(_translate("XCon_Imperial_Baking", "Save Channel Label"))
