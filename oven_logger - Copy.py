...
def oven_log(n):
    ...
    update = 'C:\\Users\\iontrap\\Dropbox\\Imperial Ion Trap\\Oven\\Data\\update.txt'
    ...
    while(True):
        try:
            ...
            update_file.write(str(current_time) + ', ' + str(res_P[0]) + ', ' + str(res_T[0])+ ', ' + str(res_T[1]) + ', ' + str(res_T[2]) + ', ' + str(res_T[3]) + ', ' + str(res_T[4]) + ', ' + str(res_T[5]) + ', ' + str(res_T[6]) + ', ' + str(res_T[7]) + '\n')
            update_file.close()
